...
const Hero = () => {
  return (
    <section
  id="home"
  className="bg-white min-h-screen flex items-center pt-8 md:pt-16" 
>
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center px-6 sm:px-4">
    ...
    >
      ...
      <motion.div
        ...
        className="mt-4 bg-white shadow-lg rounded-xl flex flex-col sm:flex-row items-center gap-3 px-4 py-3 max-w-lg mx-auto md:mx-0"
      >
        <input
          type="text"
