...
const agents = [
  { id: 1, name: "Sarah Johnson", role: "Senior Realtor", image: "./src/assets/sarah.jpg" },
  { id: 2, name: "Michael Smith", role: "Property Consultant", image: "./src/assets/michael.jpg" },
...
export default function Team() {
  ...
  return (
    <section className="py-16 bg-white">
      ...
      {/* Agent Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto px-4 sm:px-6">
        {agents.map((agent) => (
          <div key={agent.id} className="relative bg-white rounded-lg shadow-lg overflow-hidden group">
            <img
              src={agent.image}
              alt={agent.name}
